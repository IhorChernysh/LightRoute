...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/antigp/LightRoute"
  s.documentation_url = "https://github.com/antigp/LightRoute"
  s.license      = "MIT"
  s.author       = { "Vladislav Prusakov" => "hipsterknights@gmail.com" }
  s.source       = { :git => "https://github.com/antigp/LightRoute.git", :tag => "#{s.version}", :submodules => false }
